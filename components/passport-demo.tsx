  ...
  return (
    <div className="passport-demo relative mx-auto w-full max-w-[480px] lg:mr-0">
      ...
      <div className="passport-demo-paper rotate-[1deg] rounded-[28px] bg-[#081a2b] p-2 shadow-[0_30px_80px_rgba(17,24,39,0.18)]">
        <div className="grid min-h-[420px] overflow-hidden rounded-[21px] border border-[#e6c979]/55 bg-[#112a42] text-[#f1d77f] [perspective:1200px] sm:min-h-[460px]">
          <section className="passport-demo-page passport-demo-identity col-start-1 row-start-1 p-5 sm:p-7">
            ...
            <div className="mt-6 grid grid-cols-[82px_1fr] gap-4 sm:mt-7 sm:grid-cols-[105px_1fr] sm:gap-6">
          ...
          <section className="passport-demo-page passport-demo-travel col-start-1 row-start-1 p-5 sm:p-7">
            ...
            <div className="mt-6 grid grid-cols-2 gap-3 sm:mt-7 sm:gap-4">
              {content.destinations.map((destination, index) => (
                <div key={destination.name} className="min-h-24 rounded-lg border-2 border-[#f1d77f]/45 bg-[#f1d77f]/[0.08] p-3 even:rotate-1 odd:-rotate-1 sm:min-h-28 sm:p-4">
          ...
          <section className="passport-demo-page passport-demo-anthems col-start-1 row-start-1 p-5 sm:p-7">
            <p className="text-[9px] font-semibold uppercase tracking-[0.2em] text-[#e4cd8b]">{content.republic}</p>
